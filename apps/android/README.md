...
other traffic. Android offers no per-app firewall to third-party apps, and `addAllowedApplication` is
whole-tunnel: restricting it to the blocked apps would drop DNS filtering for everything else.
